...
export class ExperimentTypeModal extends Modal {
    plugin: ResearchPlugin;
    svelteTest:ReturnType<typeof SvelteImportStuff> | undefined;
    settingsTab:DraftTab;
    experimentType:ExperimentType;
    constructor(app: App,plugin: ResearchPlugin,experimentType:ExperimentType,settingsTab:DraftTab) {
            super(app);
            this.plugin = plugin;
    ...
    onOpen(): void {
        ...
        new Setting(contentEl)
            ...
            .addSearch((cb) => {
                new SubFolderSuggest(this.app, cb.inputEl, this.experimentType.folder.name);
                cb.setPlaceholder("")
                    .onChange((new_folder) => {
        ...
        this.svelteTest = mount(SvelteImportStuff, { target:this.contentEl,props:{tabs:10, folder:this.experimentType.folder} }  )
